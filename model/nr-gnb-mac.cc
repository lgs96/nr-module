...
NrGnbMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NrGnbMac")
    ...
    .AddTraceSource ("MacRxSr",
                     "SR received.",
                     MakeTraceSourceAccessor (&NrGnbMac::m_macRxSR),
                     "ns3::Time::TracedCallback")
    .AddTraceSource ("MacRxData",
                     "Data received.",
                     MakeTraceSourceAccessor (&NrGnbMac::m_macRxData),
                     "ns3::Time::TracedCallback")
...
NrGnbMac::DoReceivePhyPdu (Ptr<Packet> p)
{
  ...
  //std::cout<<Simulator::Now().GetSeconds()<<" Received MAC"<<std::endl;
  NS_LOG_FUNCTION (this);
    ...
    case (NrControlMessage::SR):
      {
        ...
        //std::cout<<Simulator::Now().GetSeconds()<<" Receive SR"<<std::endl;
...
NrGnbMac::DoSchedConfigIndication (NrMacSchedSapUser::SchedConfigIndParameters ind)
{
  ...
  //std::cout <<Simulator::Now()<< " Received from scheduler a new allocation: " << ind.m_slotAllocInfo << std::endl;
